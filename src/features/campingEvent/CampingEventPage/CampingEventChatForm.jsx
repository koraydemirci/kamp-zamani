...
class CampingEventChatForm extends Component {
  ...
  render() {
    return (
      <Form onSubmit={this.props.handleSubmit(this.handleCommentSubmit)}>
        ...
        <Button content="Yorum Ekle" labelPosition="left" icon="edit" primary />
      </Form>
    );
  }
}

export default reduxForm()(CampingEventChatForm);
